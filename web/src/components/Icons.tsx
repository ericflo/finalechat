...
export const IconAlert = (p: P) => (
  <svg {...base} {...p}><path d="M10.3 3.9L1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0z" /><path d="M12 9v4" /><path d="M12 17h.01" /></svg>
);
...
export const IconBranch = (p: P) => (
  <svg {...base} {...p}><circle cx="6" cy="4" r="2" /><circle cx="6" cy="20" r="2" /><circle cx="18" cy="8" r="2" /><path d="M6 6v12" /><path d="M18 10a6 6 0 0 1-6 6h-1" /></svg>
);
export const IconCpu = (p: P) => (
  <svg {...base} {...p}><rect x="5" y="5" width="14" height="14" rx="2" /><rect x="9" y="9" width="6" height="6" /><path d="M9 2v3M15 2v3M9 19v3M15 19v3M2 9h3M2 15h3M19 9h3M19 15h3" /></svg>
);
export const IconCoins = (p: P) => (
  <svg {...base} {...p}><circle cx="9" cy="9" r="6" /><path d="M15.5 8.5A6 6 0 1 1 8.5 15.5" /></svg>
);
