...
| `PUT /settings-resources/{resource}/website` | Register the resource's own settings website (account credential); `GET /settings-resources/{resource}` reports its bound current revision as `website` |
